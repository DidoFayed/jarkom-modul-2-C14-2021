...
2. Ketika mengerjakan pada saat praktikum, sempat melakukan konfigurasi pada folder dan Web Server yang tidak sesuai, salah menggunakan folder **jarkom** dan yang tepat seharusnya **kaizoku**. Sehingga butuh untuk membuat ulang folder dan mengkonfigurasi script-script dari awal.
